// Копирует .wasm-файлы onnxruntime и наши ONNX-модели в сборку.
// Если название вашей итоговой модели отличается от model.onnx —
// поправьте путь во второй строке паттерна ниже.
